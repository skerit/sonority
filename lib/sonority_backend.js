...
Backend = Fn.inherits('Informer', function SonorityBackend(sonority_player, options) {
	...
	if (this.sonority.debug || (this.options && this.options.debug)) {
		this.debug = true;
	}
});
 ...
 * @version  0.1.0
 */
Backend.setMethod(function load(file, callback) {
 ...
 * @version  0.1.0
 */
Backend.setMethod(function play(optional_file, callback) {
	...
	this._play(optional_file, callback);
});
 ...
 * @version  0.1.0
 */
Backend.setMethod(function _play(optional_file, callback) {
	throw new Error('Method has not been implemented in ' + this.constructor.name);
});
