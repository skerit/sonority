 ...
 * @version  0.1.0
 */
Sonority.setMethod(function load(soundpath, callback) {

	if (!this.backend) {
		this.backend = new Vlc(this);
	}

	return this.backend.load(soundpath, callback);
});
 ...
 * @version  0.1.0
 */
Sonority.setMethod(function play(soundpath, callback) {

	if (typeof soundpath == 'function') {
		callback = soundpath;
		soundpath = null;
	}
